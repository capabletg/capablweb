  ...
  return (
    <div className="bg-[#141F35]/40 px-4 sm:px-8 md:px-6 py-6 sm:py-8 md:py-9 rounded-2xl">
      ...
      >
        ...
        <button
          className="mt-3 md:mt-4 rounded-lg border-[0.1rem] border-capabl_primary bg-capabl_primary hover:bg-[#F3EDDE] transition-all duration-300 w-full py-3 text-[#231F20] text-sm"
          type="submit"
