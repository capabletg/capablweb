...
export default function Module3() {
    ...
    return (
        <div className="col-span-1 rounded-2xl bg-[#00253A] p-4 sm:px-7 sm:py-5 relative overflow-hidden">
            <img
                className="absolute z-0 bottom-0 left-0 min-w-[200%] object-contain"
            ...
            <div className="relative z-[1]">
                <div className="items-center justify-start hidden md:flex md:mb-4">
                    <p className="uppercase text-[#ff696d] font-semibold text-xs bg-white rounded-full px-3 py-1">Module 3</p>
                </div>
