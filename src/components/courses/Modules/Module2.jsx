...
export default function Module2() {
    ...
    return (
        <div className="col-span-1 rounded-2xl bg-[#00253A] p-4 sm:px-7 sm:py-5 relative overflow-hidden">
            <img
                className="absolute z-0 top-0 right-0 min-w-[200%] object-contain"
            ...
            <div className="relative z-[1]">
                <div className="items-center justify-start hidden md:flex md:mb-4">
                    <p className="uppercase text-[#ff696d] font-semibold text-xs bg-white rounded-full px-3 py-1">Module 2</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-6 mt-4 sm:mt-7">
                    ...
                    <div className="flex flex-col items-start justify-start h-full">
                        <p className="text-[#80929D] font-normal sm:font-light text-[0.6rem] sm:text-xs md:text-sm lg:text-xs mb-2 sm:mb-4">{`See Industrial Use Case`}</p>
