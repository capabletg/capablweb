...
export default function CompaniesUniversities({
  companies = [],
  roles = [],
  moreCount = "20",
  universities = [],
  ...
  return (
    <div className="w-full px-4 md:px-6 pt-6 pb-16 md:pt-8 md:pb-20 bg-[#14213D] rounded-xl md:rounded-2xl relative">
      ...
      <div className="max-w-5xl mx-auto relative z-[1]">
        <h2 className="text-center text-white font-normal text-lg sm:text-xl md:text-2xl mb-2 md:mb-3">
        ...
        <div className="flex items-center justify-evenly flex-wrap gap-4 md:gap-8 my-8 md:mt-10">
          {companies.map((img, index) => (
            <img
              ...
              src={img}
              alt="Company"
              className="w-full flex-shrink-0 max-w-[8rem] lg:max-w-[8.5rem] object-contain"
            />
          ))}
        </div>

        <p className="text-sm text-center italic text-white font-light mb-6">
          for roles like
        </p>
        ...
        <h3 className="text-center text-white font-normal text-base md:text-lg mb-7 md:mb-9">
          Apply to best Universities
        </h3>
        ...
        <div className="flex items-start justify-evenly gap-4">
          {universities.map(({ image, degree, courses }, index) => (
            <div
              key={index}
              className="flex items-center flex-col justify-start gap-2.5"
            >
              ...
              <p className="italic text-[0.7rem] md:text-xs text-[#a1a6b1]">
                {degree}
              </p>
