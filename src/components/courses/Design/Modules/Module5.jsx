      ...
      <div className="relative z-[1]">
        ...
        <div className="flex items-start justify-between gap-4 pt-1 sm:pt-4 md:pt-2 lg:pt-0">
          <p className="text-white text-base sm:text-2xl font-light">
            EV Motor Technology <span className="font-medium"></span>
          </p>
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-6 mt-6 sm:mt-9 lg:mt-8">
          ...
          <div className="flex flex-col items-start justify-start h-full">
            <p className="text-[#B3BEC4] font-normal sm:font-light text-[0.6rem] sm:text-xs md:text-sm lg:text-xs mb-0.5 sm:mb-1">{`Learn about the various Motors in EV’s & their design and simulation in Altair FluxMotor
