      ...
      <div className="max-w-7xl mx-auto mt-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-xs md:text-sm font-light text-[#bfbfbf]">
            Capabl is the best engineering ecosystem that allows engineering
            students, companies, and colleges to collaborate on jobs,
            upskilling, hands-on training online or offline, mentorship,
            research and networking to build future engineers.
          </p>
        </div>
        ...
        <div className="mb-8">
          ...
          <p className="text-xs md:text-sm font-light text-[#bfbfbf]">
            You can opt for one training program or join multiple to upskill
            yourself to be a multi-domain expert. Each program comes up with 1:1
            personal support, live sessions both online and offline, offline
            events, hackathons, design competitions, internship/job
            opportunities, peer connect, events, industry connect, industrial
            projects, resume making, interviews, and more! The ecosystem also
            enable Industry-student and Industry-college connect.
          </p>
        </div>
        ...
        <div className="grid grid-cols-12 gap-x-4 gap-y-4 justify-items-start">
          <div className="col-span-12 w-full sm:col-span-4 md:col-span-2 pt-6 flex flex-col items-start justify-start gap-1.5">
            <h5 className="font-medium text-sm text-white mb-3">
            ...
            {[
              ...
              <Link key={index} href={href}>
                <a className="font-light text-xs text-white text-opacity-75">
                  {label}
                </a>
              </Link>
            ))}
          ...
          <div className="col-span-12  w-full sm:col-span-4 md:col-span-2 pt-6 flex flex-col items-start justify-start gap-1.5">
            <h5 className="font-medium hidden text-sm text-white mb-3">
              Information
            </h5>
            {[
              { label: "FAQ", href: "/" },
              ...
              <Link key={index} href={href}>
                <a className=" hidden font-light text-xs text-white text-opacity-75">
                  {label}
                </a>
              </Link>
            ))}
          ...
          <div className="col-span-12 mt-4 md:mt-0 w-full md:col-span-5 bg-white py-6 px-10 bg-opacity-10 max-w-sm mr-auto md:mr-0 h-fit pb-10 justify-self-end">
            ...
            <p className="font-light text-xs text-white text-opacity-60">
              To get latest update about our courses and programs, please
              subscribe to our newsletter.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex flex-col md:flex-row items-center justify-start gap-4">
            ...
            <div className="flex flex-col items-start justify-start gap-1">
              <img
                className="w-full max-w-[8rem] object-contain mr-4 flex-shrink-0"
                src="/logo_white.svg"
                alt="capabl logo"
              />
              <p className="text-[0.6rem] font-light text-white text-opacity-70">
                Capabl from Elite Techno Groups
              </p>
            </div>
          ...
          <div className="flex items-center justify-center md:justify-end gap-4 order-1 lg:order-2">
            {[
              ...
              {
                icon: FaLinkedinIn,
                href: "https://in.linkedin.com/company/cabapl-elite-techno-groups",
                name: "LinkedIn",
              },
              {
                icon: FaInstagram,
                href: "https://www.instagram.com/capabl.india/",
                name: "Instagram",
              },
              {
                icon: FaTwitter,
                href: "https://twitter.com/ETgroups",
                name: "Twitter",
              },
              {
                icon: FaFacebookF,
                href: "https://www.facebook.com/CapablfromEtgroups",
                name: "Facebook",
              },
              {
                icon: FaWhatsapp,
                href: "https://wa.me/917795940242",
                name: "Whatsapp",
              },
