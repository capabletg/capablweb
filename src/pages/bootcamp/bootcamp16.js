...
const bootcamp16 = () => {
  const specificData = bootcampData.filter(item => item.Title === 'Beyond Reality: Exploring the World of Deepfake Technology');
  ...
  return (
    <Layout >
      ...
      <Header/>
            ...
            <section className="hero-section-three bg-[#656161] relative rel z-1 pt-10 rpt-150">
