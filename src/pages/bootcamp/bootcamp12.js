...
const bootcamp12 = () => {
  const specificData = bootcampData.filter(item => item.Title === 'Revolutionizing Industries: The Profound Impact of AI-Enabled Data Analytics Services');
  ...
  return (
    <Layout >
      ...
      <Header/>
            ...
            <section className="hero-section-three bg-[#4d4c4c] relative rel z-1 pt-10 rpt-150">
          ...
          <div className="row large-gap">
            ...
            <div className="col-lg-6 align-self-center">
              <div className="hero-content-three pt-10 pb-100 rpt-40">
                <h1 className="mb-25 wow fadeInUp text-white delay-0-4s" style={{fontSize: '35px'}}>
                 {data.Title}
                </h1>
