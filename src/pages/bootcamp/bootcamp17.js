...
const bootcamp17 = () => {
  const specificData = bootcampData.filter(item => item.Title === 'How to Design a Motorcycle: Step 1 - Concept');
  ...
  return (
    <Layout >
      ...
      <Header/>
            ...
            <section className="hero-section-three bg-[#625b5b] relative rel z-1 pt-10 rpt-150">
