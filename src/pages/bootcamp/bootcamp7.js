...
const bootcamp7 = () => {
  const specificData = bootcampData.filter(item => item.Title === 'Powering Up: A Look at the Diverse World of Batteries.');
  ...
  return (
    <Layout >
      ...
      <Header/>
            ...
            <section className="hero-section-three bg-[#00ffe1] relative rel z-1 pt-10 rpt-150">
