...
const bootcamp3 = () => {
  const specificData = bootcampData.filter(item => item.Title === 'Data Science v/s Data Analytics');
  ...
  return (
    <Layout >
      ...
      <Header/>
            ...
            <section className="hero-section-three bg-[#d5dfde] relative rel z-1 pt-10 rpt-150">
