...
const bootcamp5 = () => {
  const specificData = bootcampData.filter(item => item.Title === 'Careers in Data Science');
  ...
  return (
    <Layout >
      ...
      <Header/>
            ...
            <section className="hero-section-three bg-[#2d2d2d] relative rel z-1 pt-10 rpt-150">
