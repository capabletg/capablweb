...
const bootcamp4 = () => {
  const specificData = bootcampData.filter(item => item.Title === 'Will AI replace CAD engineers?');
  ...
  return (
    <Layout >
      ...
      <Header/>
            ...
            <section className="hero-section-three bg-[#b8d4d0] relative rel z-1 pt-10 rpt-150">
