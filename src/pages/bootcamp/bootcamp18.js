...
const bootcamp18 = () => {
  const specificData = bootcampData.filter(item => item.Title === 'Roadmap for a Successful Career in Tech');
  ...
  return (
    <Layout >
      ...
      <Header/>
            ...
            <section className="hero-section-three bg-[#333232] relative rel z-1 pt-10 rpt-150">
