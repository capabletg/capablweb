...
const bootcamp8 = () => {
  const specificData = bootcampData.filter(item => item.Title === 'Data Science: A boon or a curse');
  ...
  return (
    <Layout >
      ...
      <Header/>
            ...
            <section className="hero-section-three bg-[#686969] relative rel z-1 pt-10 rpt-150">
