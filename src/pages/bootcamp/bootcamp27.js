...
const bootcamp27 = () => {
  const specificData = bootcampData.filter(item => item.Title === 'Beyond Beauty: Unveiling the Design Secrets of Formula 1 Cars');
  ...
  return (
    <Layout >
      ...
      <Header/>
            ...
            <section className="hero-section-three bg-[#f4f7f7] relative rel z-1 pt-10 rpt-150">
          ...
          <div className="row large-gap">
            ...
            <div className="col-lg-6 align-self-center">
              <div className="hero-content-three pt-10 pb-100 rpt-40">
                <h1 className="mb-25 wow fadeInUp text-dark delay-0-4s">
                 {data.Title}
                </h1>
