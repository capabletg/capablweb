...
const bootcamp22 = () => {
  const specificData = bootcampData.filter(item => item.Title === 'Understanding Voice Assistants');
  ...
  return (
    <Layout >
      ...
      <Header/>
            ...
            <section className="hero-section-three bg-[#c4c7a6] relative rel z-1 pt-10 rpt-150">
