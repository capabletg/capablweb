...
const bootcamp6 = () => {
  const specificData = bootcampData.filter(item => item.Title === 'The Art & Science of Kuka Robots');
  ...
  return (
    <Layout >
      ...
      <Header/>
            ...
            <section className="hero-section-three bg-lighter relative rel z-1 pt-10 rpt-150">
