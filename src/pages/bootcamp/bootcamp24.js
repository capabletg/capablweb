...
const bootcamp24 = () => {
  const specificData = bootcampData.filter(item => item.Title === 'Why is Data Science Important in today’s world');
  ...
  return (
    <Layout >
      ...
      <Header/>
            ...
            <section className="hero-section-three bg-[#212223] relative rel z-1 pt-10 rpt-150">
