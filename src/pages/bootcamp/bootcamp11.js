...
const bootcamp11 = () => {
  const specificData = bootcampData.filter(item => item.Title === 'Evolution of EV');
  ...
  return (
    <Layout >
      ...
      <Header/>
            ...
            <section className="hero-section-three bg-[#1c1b1b] relative rel z-1 pt-10 rpt-150">
