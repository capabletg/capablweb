...
const bootcamp13 = () => {
  const specificData = bootcampData.filter(item => item.Title === 'Toroidal Propeller - The next step in Aeronautics');
  ...
  return (
    <Layout >
      ...
      <Header/>
            ...
            <section className="hero-section-three bg-[#eceaea] relative rel z-1 pt-10 rpt-150">
