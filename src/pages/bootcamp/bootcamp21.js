...
const bootcamp21 = () => {
  const specificData = bootcampData.filter(item => item.Title === 'How to Design a Motorcycle: Step 2 - Frame & Ergonomics');
  ...
  return (
    <Layout >
      ...
      <Header/>
            ...
            <section className="hero-section-three bg-[#b8c4b9] relative rel z-1 pt-10 rpt-150">
