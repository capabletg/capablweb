...
const bootcamp9 = () => {
  const specificData = bootcampData.filter(item => item.Title === "Combustion Engines you haven't heard of")
  ...
  return (
    <Layout >
      ...
      <Header/>
            ...
            <section className="hero-section-three bg-[#f1f6f5] relative rel z-1 pt-10 rpt-150">
