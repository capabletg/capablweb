...
const bootcamp26 = () => {
  const specificData = bootcampData.filter(item => item.Title === 'What is Data Science Life Cycle?');
  ...
  return (
    <Layout >
      ...
      <Header/>
            ...
            <section className="hero-section-three bg-[#3e3e3e] relative rel z-1 pt-10 rpt-150">
