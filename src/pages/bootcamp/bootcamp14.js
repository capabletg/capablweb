...
const bootcamp14 = () => {
  const specificData = bootcampData.filter(item => item.Title === 'Understanding Computer Vision: How Machines Interpret Visual Data');
  ...
  return (
    <Layout >
      ...
      <Header/>
            ...
            <section className="hero-section-three bg-[#3a3333] relative rel z-1 pt-10 rpt-150">
