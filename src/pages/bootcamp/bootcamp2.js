...
const bootcamp2 = () => {
  const specificData = bootcampData.filter(item => item.Title === 'Types of motors in automobiles');
  ...
  return (
    <Layout >
      ...
      <Header/>
            ...
            <section className="hero-section-three bg-[#3c4846] relative rel z-1 pt-10 rpt-150">
