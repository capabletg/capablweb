...
const bootcamp19 = () => {
  const specificData = bootcampData.filter(item => item.Title === 'The Symphony of Efficiency: How Hybrid Cars Achieve Astounding Mileage');
  ...
  return (
    <Layout >
      ...
      <Header/>
            ...
            <section className="hero-section-three bg-[#b2bbbc] relative rel z-1 pt-10 rpt-150">
          ...
          <div className="row large-gap">
            ...
            <div className="col-lg-6 align-self-center">
              <div className="hero-content-three pt-10 pb-100 rpt-40">
                <h1 className="mb-25 wow fadeInUp text-dark delay-0-4s" style={{fontSize: '45px'}}>
                 {data.Title}
                </h1>
                <div className="hero-btns mt-10 wow fadeInUp delay-0-8s">
                    <a className="theme mt-1 fas fa-calendar" style={{color:'dark'}}>
                    &nbsp;&nbsp; {data.Date}
                    </a>
                    <a className="theme style-two mt-1 fas fa-clock" style={{color:'dark'}}>
                     &nbsp;&nbsp; Time:  {data.Time} pm
                    </a>
