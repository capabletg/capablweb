...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        <title>
          Online Courses for data science, data analytics, mechatronics, design
          Engineering Students | Capabl
        </title>
  ...
  gtag('config', 'G-Q3GNQFZWRP');`}
      ...
      <main className="min-h-screen w-full">
        ...
        >
          ...
          <div className="relative md:order-2 flex-shrink-0 pt-5 md:pt-0">
            <div className="z-[2] relative bg-capabl_primary rounded-md mb-6 w-[14rem] md:w-[22.5rem] h-[17.5rem] md:h-[28rem] p-4 transform translate-x-[7.5%] md:translate-x-0">
              ...
              <img
                className="absolute bottom-[47%] right-[10%] object-contain w-[16%]"
                src="/images/svgs/aws_icon.svg"
                alt="aws icon"
              />
              <img
                className="absolute bottom-[30%] right-[10%] object-contain w-[16%]"
                src="/images/svgs/azure_icon.svg"
                alt="azure icon"
              />
              <img
                className="absolute bottom-[13%] right-[10%] object-contain w-[16%]"
                src="/images/svgs/gcp_icon.svg"
                alt="gcp icon"
              />
            </div>
            <img
            ...
            <div className="relative">
              <div className="rounded-lg relative z-[2] md:rounded-2xl py-5 md:py-8 px-4 md:px-8 light_shadow md:shadow-none bg-white md:bg-[#f2f4f7] flex items-start justify-between gap-4 md:gap-6 mt-5 md:mt-10">
                <p className="flex flex-col items-center justify-start md:items-start gap-1">
                  <span className="text-[#371B69] font-semibold text-xs md:text-xl md:bold">
                    1.5 lakh+
                  </span>
                  <span className="text-[#898989] md:text-black text-[9px] md:text-sm text-center md:text-left">
                    Careers Transformed
                  </span>
                </p>
                {/* <p className="flex flex-col items-center justify-start md:items-start gap-1">
        ...
        <section
          ...
          className="hidden py-4 md:py-20 container mx-auto max-w-7xl"
        >
            ...
            {!!studentTestimonials?.length &&
              studentTestimonials.map((item, index) => (
                <div key={index} className="flex-shrink-0">
                  <div
                    className={`${
                      index % 2 === 0 ? "bg-[#F8F7FF]" : "bg-[#FFFEFD]"
                    } w-full max-w-xs h-[600px] mx-auto relative p-6`}
                  >
                    <h2 className="text-left font-semibold text-lg mb-4">
                      {item?.title}
                    </h2>
                    <p className="text-left font-light text-sm mb-4">
                      {item?.description}
                    </p>
        ...
        <section
          id="associations"
          className="mt-8 container mx-auto max-w-7xl px-4 pt-4 md:pt-16"
        >
...
/>
            ...
            <div className="max-w-6xl mx-auto pb-4 pt-8 md:pt-16 md:pb-6 grid grid-cols-2 gap-4 lg:gap-10">
              ...
              <div className="block md:gap-10">
                <div className="relative mb-4 flex-shrink-0">
                  <h3 className="font-semibold text-lg  md:text-3xl md:leading-[3rem]">
                    <span className="relative">
        ...
        <section
          id="features"
          className="bg-[#F2F4F7] w-full rounded-3xl max-w-screen-2xl mx-auto px-2 py-10 pb-28 md:py-16 mb-40"
        >
          <div className="mb-10 md:mb-12 max-w-md md:max-w-3xl mx-auto px-4">
        ...
        <section
          id="present_across"
          className="mt-10 md:mt-20 lg:mt-48 px-4 mb-12 md:mb-20"
        >
          <div
            style={{
            ...
            <div className="md:grid md:grid-cols-7 md:gap-2 max-w-5xl mx-auto">
              <div className="p-4 md:col-span-4">
                ...
                <div className="font-normal max-w-lg text-sm mb-6 md:mb-8 text-[#636363]">
                  As per the NEP and directives by GoI, Academia Industry
                  Collaboration (AIC) by Capabl help colleges improve Industrial
                  exposure, infrastructure and make them part of an engineering
                  Ecosystem - taking the college to the next level.
                </div>
              ...
              <div className="overflow-x-scroll pt-0 pb-6 scrollbar-hide px-4 md:col-span-3 md:row-span-2 md:pl-12">
                <div className="flex items-center justify-start gap-4 md:gap-8 md:grid md:grid-cols-2 md:justify-items-end">
                  {presentColleges?.map(({ image, name }, index) => (
                    ...
                    >
                      <img
                        className="w-full max-w-[45px] md:max-w-[90px]"
                        src={image}
                        alt={name}
                      />
                      <p className="font-medium text-black text-[9px] md:text-base text-center">
                        {name}
                      </p>
                    </div>
                  ))}
              ...
              <div className="mt-2 max-w-sm md:max-w-none md:col-span-4">
                <p className="font-medium text-xs md:text-lg text-[#807E7E] mb-5 md:mb-10 px-4">
                  Students from all colleges across India are joining the
