            ...
            <Script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        description:
                            "Get certified & placed in top tech companies with our mechatronics course. Topics covered from scratch to advanced with live industry projects to work on.",
                        brand: {
                            "@type": "Brand",
                            name: "Capabl",
                        },
            ...
            <main className="min-h-screen w-full">
                ...
                <section id="hero" className="px-4 pt-6 md:pt-7 grid grid-cols-1 md:grid-cols-5 lg:grid-cols-2 max-w-7xl mx-auto">
                    <div className="col-span-1 md:col-span-2 lg:col-span-1 w-full relative flex items-center justify-center md:order-1">
                        ...
                        <button
                            style={{ background: "#076DE5" }}
                            className="absolute z-[2] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  flex items-center justify-center text-white text-sm w-10 h-10 rounded-full pl-0.5"
                        >
                            <FaPlay />
                        </button>
                    </div>
                    ...
                    <div className="col-span-1 md:col-span-3 lg:col-span-1 mt-12 md:pb-12">
                        ...
                        >
                            {`From`}
                            <span style={{ color: "#076DE5" }}>{` 0 `}</span>
                            {`to`}
                            <span style={{ color: "#076DE5" }}>{` Hero `}</span>
                            {`in `}
                            <span
                                className={`relative font-semibold after:w-full after:h-0.5 md:after:h-[0.1875rem] after:absolute after:bottom-0 after:left-0 after:bg-[#076DE5]`}
                            >
                                {`Mechatronics`}
                            </span>
                        ...
                        <div className="col-span-1 md:col-span-2 text-white pt-8 md:pt-0 flex flex-col justify-start md:justify-center max-w-lg">
                            ...
                            <button className="flex items-center justify-start gap-1 text-sm font-normal group">
                                ...
                                <span className="transform rotate-90">
                                    <FiChevronUp style={{ color: "#076DE5" }} className={`text-lg group-hover:animate-bounce`} />
                                </span>
                            </button>
                        </div>
                ...
                <section className="mt-16 md:mt-20 max-w-7xl mx-auto">
                    <h2 className="text-center font-medium text-lg md:text-2xl max-w-xs md:max-w-sm mx-auto px-4">
                        Why wait, Take the journey now to be <span style={{ color: "#076DE5" }}>Capabl</span>
                    </h2>
