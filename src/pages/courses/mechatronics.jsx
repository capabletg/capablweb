...
const accordianData = [
  ...
  },
  {
    ...
    description: `Get - updates on national/international events, your major-minor projects done, credits for internships, industrial projects in Mechatronics, and services that help you be Capabl`,
...
const moduleData = [
  ...
  {
    name: "Module 2",
    modulename: " Embedded System in Mechatronics",
    moduleindex: 1,
    intro:
  ...
  },
  {
    ...
    modulename: "Robotics",
    moduleindex: 4,
    intro: "  Learn Robotics and Industrial Application in workspace",
    heading1: "Projects",
    content1: [
    ...
    heading2: "Skills",
    content2: [
      "Basic Knowledge Robotic End Effector",
      "Basic Knowledge of Industrial Robots",
      "Basic knowledge in the Robot workspace visualization",
    ],
    Sub_topics: "7",
    No_Projects: "3",
    heading3: "Job Roles",
      ...
      <main className="min-h-screen w-full">
        ...
        >
          ...
          <div className="col-span-1 md:col-span-3 lg:col-span-1 mt-12 md:pb-12">
            <h1
              title="Be NaukriSaksham in Mechatronics with a core job, not just a degree!"
        ...
        <section className="max-w-7xl hidden mx-auto mt-16 md:mt-20 pl-0 md:pl-4">
          <div className="p-4 md:py-10 md:pl-10 md:rounded-tl-2xl md:rounded-bl-2xl bg-[#14213D] grid grid-cols-1 md:grid-cols-7 gap-4 md:gap-20">
            <div className="col-span-1 md:col-span-2 text-white pt-8 md:pt-0 flex flex-col justify-start md:justify-center max-w-lg">
              <h2 className="font-semibold text-lg md:text-xl mb-3 md:mb-5">{`Our alumni going places in the Mechatronics Domain!`}</h2>
        ...
        <section className="px-4 lg:px-6 mt-6 lg:mt-8 max-w-7xl mx-auto">
          <h2 className="text-center font-medium text-lg md:text-2xl mb-3 lg:mb-4">
            Become a real Mechatronics Engineer with the Capabl Ecosystem!
          </h2>
        ...
        <section className="mt-32 md:mt-40 mx-auto max-w-7xl px-4 md:px-6">
          <div className="relative mb-8 md:mb-11">
            ...
            <h2 className="text-center font-medium text-lg md:text-2xl mb-3 md:mb-4 text-black">{`Ace your dream career in Mechatronics!`}</h2>
        ...
        <section className="max-w-7xl mx-auto px-4 mt-20">
          ...
          <h2 className="text-center font-medium text-lg md:text-2xl mb-3 md:mb-4 text-black">{`Pathway to become a kick-ass Mechatronics Engineer!`}</h2>
          <p className="text-xs md:text-sm max-w-md md:max-w-2xl mx-auto text-center font-normal text-[#6c6c6c]">
            {`Our Mechatronics module is verified by working professionals from companies like Amazon, ABB and Honeywell and graduates of Stanford & IITs, taught by top industry experts in a systematic manner, with practical foundation.`}
          </p>
