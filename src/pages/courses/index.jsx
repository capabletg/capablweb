                ...
                <section id="hero" className="px-4 pt-6 md:pt-7 grid grid-cols-1 md:grid-cols-5 lg:grid-cols-2 max-w-7xl mx-auto">
                    ...
                    <div className="col-span-1 md:col-span-3 lg:col-span-1 mt-12 md:pb-12">
                        ...
                        >
                            ...
                            {`to`}
                            <span className="text-[#FFCC00]">{` Hero `}</span>
                            {`in `}
                            <span className="relative font-semibold after:w-full after:h-0.5 md:after:h-[0.1875rem] after:absolute after:bottom-0 after:left-0 after:bg-[#FFCC00]">
                                {`Data Science`}
                            </span>
                            ...
                            >
                                ...
                                />
                                <path
                                    d="M102.423 32.4658C101.316 28.2461 100.342 23.9461 99.6149 19.6231C98.8888 15.2856 98.5469 10.8643 97.7027 6.56012C97.3761 4.90311 95.1 5.1455 95.0228 6.84265C94.6228 15.7541 97.4175 25.181 100.609 33.2168C101.055 34.3233 102.731 33.6382 102.423 32.4658Z"
                                    fill="#FFCC00"
                                />
                                <path
                                    d="M98.9279 33.1836C92.0995 32.9095 84.8485 33.9203 78.6529 37.3377C77.3596 38.0534 78.3858 40.0327 79.668 39.4746C85.9687 36.7323 92.0949 34.5282 98.8917 34.1255C99.4248 34.0957 99.4846 33.2075 98.9279 33.1836Z"
                                    fill="#FFCC00"
                                />
                            </svg>
                        </h1>
                        ...
                        <div className="flex items-center justify-center md:justify-start gap-2 mt-6">
                            <button className="font-medium text-center py-2 px-3 border border-transparent rounded-lg text-sm text-[#272727] bg-[#FFCC00]">
                                Talk to Counselor
                            </button>
                        </div>
