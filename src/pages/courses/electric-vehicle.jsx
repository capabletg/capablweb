...
import Faqs from "../../components/courses/Faqs_ev";
...
const moduleData = [
  {
    ...
    content2: [
      "Powertrain Design",
      "Battery cell modeling calculation",
      "EV transmission calculation",
      "Battery pack design",
    ],
    Sub_topics: "10",
    No_Projects: "5",
  ...
  },
  {
    ...
    heading1: "Projects",
    content1: [
      "Create a summary report on the Tesla Model S battery pack evolving from 2012 to 2022",
      "Study and understanding of an entry-level VCU based on the 32-bit STM32 microcontroller",
      "Retro fitment of an LCV",
    ],
    skills: "3-4",
    heading2: "Skills",
    content2: [
  ...
  },
  {
    ...
    content1: [
      ...
      "Implementation of the Coulomb Counting Algorithm",
    ...
    content2: [
      ...
      "Manufacturing process for battery",
      "Simulink modeling",
    ],
    Sub_topics: "13",
    No_Projects: "3",
  ...
  },
  {
    ...
    heading1: "Projects",
    content1: [
      "Designing a Battery Pack Module for an Electric Car using CAD tools-PTC CREO",
      "CFD Analysis of Battery Cooling System to reduce the rise in temperature using Ansys Fluent",
    ...
    content2: [
      ...
      "Thermal Modelling of Li-ion Batteries",
    ],
    Sub_topics: "21",
    No_Projects: "3",
    heading3: "Job Roles",
    content3: [
      "Batterypack Engineer",
      "Simulation Engineer",
      "CFD Engineer",
      "CAE Analyst",
    ],
  },
  {
    ...
    content2: [
      "Topology of Motors",
      "Motor Selection techniques",
      "Motor component design(Stator, rotor, etc)",
      "Motor component analysis(FEA, Thermal, NVH)",
    ],
    Sub_topics: "17",
    No_Projects: "3",
    heading3: "Job Roles",
  ...
  },
  {
    ...
    content1: [
      ...
      "Design and Selection of a suitable Cooling System",
    ],
    skills: "3-4",
    heading2: "Skills",
    content2: [
      ...
      "PCB design for EV",
      "Onboard and offboard charger design",
    ],
    Sub_topics: "21",
    No_Projects: "3",
    heading3: "Job Roles",
  ...
  },
  {
    ...
    content1: [
      ...
      "Creating a Subsystem and Analyzing the serial flow using Canalyzer",
    ],
    skills: "3-4",
    heading2: "Skills",
    content2: [
      "Error Detection and Rectification",
      "Building a Subsystem of CAN",
      "Use Of Communication protocols in EV",
    ],
    Sub_topics: "7",
    No_Projects: "3",
    heading3: "Job Roles",
  ...
  },
  {
    ...
    heading2: "Skills",
    content2: [
      "Wiring Harness Design Calculations",
      "Wire Gauge Design Calculations",
      "Fuse Calculations",
  ...
  },
  {
    ...
    content2: [
      "EV Testing",
      "Motor related tests",
      "Charger related tests",
      "DC-DC converter related tests",
      "VCU related tests",
    ],
    Sub_topics: "17",
    No_Projects: "3",
...
const moduleDataExtended = [
  [
    ...
    "MATLAB Modeling",
    "Finding input parameters for Vehicle Model",
  ],
  [
    "Electric Vehicle Architecture",
    "Control Systems Architecture",
    "Architecture for EVs",
    "EV Retrofitting & Charging Protocols",
    "EV Policy Landscape, Patent Landscape, and Case Studies",
  ],
  [
    "Vehicle Technology History & Evolution",
    "Lithium-ion Battery Technology",
    "Lithium-ion Battery Terminologies",
    "Battery Pack Engineering",
    "Battery Pack Thermal Engineering",
    "Battery Management System",
  ],
  [
    "Introduction to Battery and Battery Pack design",
    "Battery Pack Component Selection",
    "Creo Modeling Introduction",
  ...
  [
    ...
    "Fundamentals of Electric Motor",
  ...
  [
    "Introduction of Power Electronics in EV",
    "Insight into Power Electronic Circuits",
    "Circuits components & Selection",
    "Converters, Inverters & Motor Drivers",
    "Battery Algorithms & Chargers",
    "Battery Thermal System Design",
    "Future of Power Electronics in EVs",
  ],
  ["Introduction to CAN", "CAN Analyzing", "LIN & Flexray protocols"],
  [
    "Introduction To Wiring Harness Design",
    "Wiring Harness Design",
    "Wiring Harness Component Specifications & Selection Parameters",
    "Wiring Harness Designing",
    "Manufacturing & Documentation",
  ],
  ["Homologation Basics", "Testing Standards", "EV Testing", "Safety in EV’s"],
];
      ...
      <main className="min-h-screen w-full">
        ...
        >
          ...
          <div className="col-span-1 md:col-span-3 lg:col-span-1 mt-12 md:pb-12">
            <h1
              title="Be NaukriSaksham in Electric Vehicles with a core job, not just a degree!"
            ...
            <div className="hidden max-w-xl relative z-[2] rounded-lg p-6 light_shadow shadow-none bg-white md:bg-[#f2f4f7] md:flex items-start justify-between gap-4 md:gap-6 mt-5 md:mt-10">
              ...
              <p className="flex flex-col items-center justify-start gap-1">
                <p className="flex flex-row items-center justify-start gap-1">
                  ...
                  <span className="text-[#371B69] font-semibold text-lg">{` 10`}</span>
                </p>
                <span className="text-black text-xs text-left">
                Industrial Projects 
                </span>
