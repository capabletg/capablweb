            ...
            <main className="min-h-screen w-full mx-auto">
                ...
                <section id="about" className="mt-4 mx-4 md:mx-12 ">
                    <div className="grid grid-cols-1 md:grid-cols-2 md:divide-y max-w-7xl mx-auto">
                        <div className="block p-8 rounded-lg  bg-gray-100">
                            <h5 className="text-gray-900 text-xl leading-tight font-medium mb-2">About Capabl</h5>
                            <p className="text-base mb-4">
                                Elite Techno Groups is an India-based company focused on creating an engineering ecosystem around Skills needed for industry. We
                                help students embrace the industrial requirements by exposing them to real-world scenarios and providing them with the impetus
                                to apply their skills and knowledge to tackle the challenges presented.
                            </p>

                            <p>
                                With a reliable team of more than 100 Experts from various Industries led by Founder Mr. Mayank Arora who has 8yr+ Experience in
                                the EdTech Industry and Co-Founder Mr. Umang Surana who is an IIT Madras Alumnus - we ensure the best outcomes to our student
                                fraternity. Winning More than 26 Awards ensures our credibility.
                            </p>
                            <p>
                                To date, we have skilled 1 Lakh+ Student from 400+ Colleges from all of the Indian states and 15+ countries globally. We even
                                had offline programs across India, UAE, and South Africa. To date, we have skilled 1 Lakh+ Student from 400+ Colleges from all
                                of the Indian states and 15+ countries globally. We even had offline programs across India, UAE, and South Africa.
                            </p>
                        </div>
                ...
                <section id="press">
                    <div className="mb-10 mt-12 md:mb-12 max-w-sm md:max-w-3xl mx-auto ">
                        <h2 className="text-center text-black font-semibold text-base md:font-medium md:text-4xl mb-4 md:mb-6">Capabl in Press</h2>
                    </div>
                    <PressSlider />
                </section>
                <section id="leaders">
                    <div className="grid grid-cols-1 divide-y max-w-7xl mx-auto">
                        <div>
                            <h2 className="text-center text-black font-semibold text-base md:font-medium md:text-4xl mt-4">Listen to our leaders</h2>
                        </div>
                        <div className=" overflow-x-scroll scrollbar-hide w-full mt-6 md:mt-8 mb-8 md:mb-12 flex items-start justify-start lg:justify-between gap-4 px-4">
                            {!!pressreleases?.length &&
                                pressreleases.map((item, index) => (
                                    <div key={index} className="p-4 lg:p-8 flex-shrink-0 w-fit md:flex-shrink  border-white md:w-1/2">
                                        <div className="bg-white relative rounded-lg">
                                            <img src="/images/media/leaders.png" alt="" className="rounded-t-lg " />
                                            <div
                                        ...
                                        <div className="p-6">
                                            <p className="text-700 mb-2">Creating The Culture You Want To See In Your...</p>
                                        </div>
                                    </div>
                                ))}
                        </div>
                ...
                <section id="awards">
                    <div className="m-8 max-w-7xl mx-4 md:mx-auto">
                        ...
                        <div className="text-left grid grid-col-2 gap-0">
                            <h2 className=" text-black font-semibold text-base md:font-medium md:text-4xl mb-2 text-left ">Awards &</h2>
                            <h2 className=" text-black font-semibold text-base md:font-medium md:text-4xl mb-4 md:mb-6 text-left ">Achivements</h2>
                        </div>
                ...
                <section id="accredition">
                    <div className="max-w-7xl mx-4 md:mx-auto m-8 bg-[#14213D] rounded-lg p-4 md:p-8">
                        ...
                        <h2 className="text-white font-semibold text-base md:font-medium md:text-4xl mb-4 md:mb-6 text-left ">Accredited by</h2>
                        <div className="bg-white rounded-lg grid grid-cols-3 justify-items-center xl:grid-cols-5 ">
                            {!!accreditedby &&
                                accreditedby.map((item, index) => (
                                    ...
                                    >
                                        <img src={item.image} alt={item.accreditedby} className="self-center" />
                                    </div>
                                ))}
                        </div>
                    </div>
                        ...
                        <div className="relative md:pt-20 bg-[#14213D]">
                            ...
                            <div className="hidden  absolute top-[-20%] w-full md:flex md:justify-center md:gap-4">
                                <div className="rounded-xl p-4 bg-[#FF696D] w-[290px] h-[160px]">
                                    <h6 className=" text-black text-lg font-semibold">Media Kit</h6>
                                    <p> Download everything you need to say about us!</p>
                                </div>
                                <div className="rounded-xl p-4 bg-[#FCA600] w-[290px] h-[160px]">
                                    <h6 className="text-black text-lg font-semibold">For Press Querries</h6>
