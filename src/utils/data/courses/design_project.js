...
export const Skills = [
  "ATV Suspension calculations, Chassis Modeling",
  "CAD modeling, Steering systems,Steering-suspension coordination",
  "Part modeling, FEA Stress Analysis",
  "Part modeling, Material selection",
  "Convert surface to solid, Add design features to strengthen the component",
  "Surface creation & modifications, Prototyping",
  "Roof snow load calculations, Roof roll over calculations, Surface modeling",
  "Surface modeling & Forming, Embossing & Hemming",
  "Surface modeling, Hemming & punching",
  "Complex solid modeling, Importing standardized parts, Using imported parts",
  "Complex solid modeling, Importing standardized parts, Using imported parts",
  "CAD modeling, BOM creation",
  "Surface modeling, DFM & DFA",
  "Complex Assemblies, Coil winding design",
  "Structural Analysis, Material Selection",
  "Crash test Analysis",
  "Meshing, Topology Optimization",
  "CFD setup, Thermodynamics, Flow field",
  "Lift thrust force calculations, Fluid flow behavior",
  "Drag and Lift, Fluid flow behavior",
];
